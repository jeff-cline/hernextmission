...
?>
<!-- wp:group {"className":"hnm-section hnm-podcast","layout":{"type":"constrained","contentSize":"1320px"},"style":{"spacing":{"padding":{"top":"7rem","bottom":"7rem","left":"1.5rem","right":"1.5rem"}}}} -->
<div class="wp-block-group hnm-section hnm-podcast" style="padding:7rem 1.5rem">
    ...
    <div class="wp-block-columns are-vertically-aligned-center">
        ...
        <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
            ...
            <!-- wp:html -->
            <p style="margin:0 0 1rem"><span class="hnm-eyebrow">The Podcast · From Service to Success</span></p>
            <!-- /wp:html -->

            <!-- wp:heading {"level":2,"style":{"typography":{"fontSize":"clamp(2.25rem, 4.2vw, 3.25rem)","fontWeight":"500","lineHeight":"1.08"}}} -->
            <h2 class="wp-block-heading" style="font-size:clamp(2.25rem, 4.2vw, 3.25rem);font-weight:500;line-height:1.08">Her voice. HER STORY. HER NEXT MISSION.</h2>
            <!-- /wp:heading -->
            ...
            <div class="wp-block-buttons">
                ...
                <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-navy-deep-color has-text-color has-border-color wp-element-button" href="<?php echo esc_url($cta_guest); ?>" style="border-color:#1F2A52;border-width:1px;border-radius:999px">Submit Your Story</a></div>
                <!-- /wp:button -->
            </div>
            <!-- /wp:buttons -->
